...
class BLIP_Retrieval(nn.Module):
    def __init__(self,                 
        ...
        self.sense_proj_v = nn.Linear(embed_dim, embed_dim*self.num_senses)
        self.sense_proj_m_v = nn.Linear(embed_dim, embed_dim*self.num_senses)
        self.sense_proj_l = nn.Linear(embed_dim, embed_dim*self.num_senses)
        self.sense_proj_m_l = nn.Linear(embed_dim, embed_dim*self.num_senses)
        
        self.model_pairs = [[self.visual_encoder,self.visual_encoder_m],
                            [self.vision_proj,self.vision_proj_m],
                            [self.text_encoder,self.text_encoder_m],
                            [self.text_proj,self.text_proj_m],
                            [self.sense_proj_v, self.sense_proj_m_v],
                            [self.sense_proj_l, self.sense_proj_m_l]
                           ] 
        self.copy_params()
    ...
    def forward(self, image, caption, idx):
        ...
        B,D = v_embed.shape
        v_sense_embed = self.sense_proj_v(v_embed).view(B,self.num_senses,D)
        l_sense_embed = self.sense_proj_l(l_embed).view(B,self.num_senses,D)
        ...
        with torch.no_grad():
            ...
            v_sense_embed_m = self.sense_proj_m_v(v_embed_m).view(B,self.num_senses,D)
            ...
            l_sense_embed_m = self.sense_proj_m_l(l_embed_m).view(B,self.num_senses,D)
        ...
        return loss_ita, torch.zeros_like(loss_ita)
