...
def evaluation(model, data_loader, device, config, args):
    ...
    for idx, (image, img_id, img_path, caption, topic) in enumerate(data_loader): 
        ...
        v_sense_embed = model.sense_proj_v(image_embed).view(B,model.num_senses,D)
        l_sense_embed = model.sense_proj_l(text_embed).view(B,model.num_senses,D)
...
def main(args, config):
    ...
    # from models.blip_finegrained_separate import blip_retrieval
