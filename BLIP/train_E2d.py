...
def evaluation(model, data_loader, device, config, args):
    ...
    for idx, (image, img_id, img_path, caption, topic) in enumerate(data_loader): 
        ...
        text_embed = F.normalize(text_embed_dom.squeeze(1), dim=-1)  
        image_embed = F.normalize(image_embed_dom.squeeze(1),dim=-1) 
...
def main(args, config):
    ...
    from models.blip_E2d import blip_retrieval
