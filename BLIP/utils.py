...
# def itc_eval(sims_matrix, txt2img, img2txt):
#     img2text_pred_rank = sims_matrix.argsort(dim=-1, descending=True) # max `first`
#     img2text_ranks = torch.where(img2text_pred_rank == img2txt.unsqueeze(-1))[1]
...
#     print(img2txt)
#     print(sims_matrix)
#     print(img2text_pred_rank)
#     print(img2text_ranks)

# if __name__ == '__main__':
#     sims_matrix = torch.randn((10,10))
#     txt2img = torch.arange(10)
#     img2txt = torch.arange(10) 
#     itc_eval(sims_matrix,txt2img,img2txt)